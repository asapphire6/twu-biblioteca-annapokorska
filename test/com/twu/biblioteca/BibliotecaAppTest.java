...
public class BibliotecaAppTest {
    ...
    public void shouldReturnFalseOnInvalidMenuSelection(){
        assertFalse("Menu selection is valid: ", testBiblioteca.getMenu().validateMenuSelection("List"));
    }

    @Test
    public void shouldReturnTrueOnValidMenuSelection(){
        assertTrue("Menu selection is valid: ", testBiblioteca.getMenu().validateMenuSelection("List of books"));
    }
